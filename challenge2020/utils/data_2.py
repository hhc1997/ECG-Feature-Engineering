...
def loaddata():
    ...
    # load_fn5 = '/home/weiyuhua/AFClassification/preprocessed_data/data_aug_test.mat'
    ...
    # load_fn_val = '/home/weiyuhua/AFClassification/preprocessed_data/data_aug_val.mat'
    ...
    # load_fn_r = '/home/weiyuhua/AFClassification/preprocessed_data/data_aug-rwave.mat'
    ...
    with open(os.path.join(data_path, 'data_aug_rwave.pkl'), 'rb') as fin:
        res = dill.load(fin)
    R = res['trainsetPeaks-r']
    val_R = res['valsetPeaks-r']
    test_R = res['testsetPeaks-r']
    R_index = []
    val_R_index = []
    test_R_index = []
    Y = []
    ...
    # load_fn_p = '/home/weiyuhua/AFClassification/preprocessed_data/data_aug-pwave.mat'
    ...
    with open(os.path.join(data_path, 'data_aug_pwave.pkl'), 'rb') as fin:
        res = dill.load(fin)
    P = res['trainsetPeaks-p']
    val_P = res['valsetPeaks-p']
    test_P = res['testsetPeaks-p']
    ...
    # load_fn_q = '/home/weiyuhua/AFClassification/preprocessed_data/data_aug-qwave.mat'
    ...
    with open(os.path.join(data_path, 'data_aug_qwave.pkl'), 'rb') as fin:
        res = dill.load(fin)
    Q = res['trainsetPeaks-q']
    val_Q = res['valsetPeaks-q']
    test_Q = res['testsetPeaks-q']
    Q_index = []
    val_Q_index = []
    test_Q_index = []
    ...
    # load_fn_t = '/home/weiyuhua/AFClassification/preprocessed_data/data_aug-twave.mat'
    ...
    with open(os.path.join(data_path, 'data_aug_twave.pkl'), 'rb') as fin:
        res = dill.load(fin)
    T = res['trainsetPeaks-t']
    val_T = res['valsetPeaks-t']
    test_T = res['testsetPeaks-t']
    T_index = []
    val_T_index = []
    test_T_index = []
