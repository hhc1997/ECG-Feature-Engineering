...
class Classifier_RESNET_V2:
    def __init__(self,input_shape=(30000,12), nb_classes=9,type=1, convfilt=64, ksize=16, depth=23,drop=0.5, head_dropout_rate=0):

        if type==1:
            self.model = self.build_model(input_shape, nb_classes, convfilt, ksize, depth,drop, head_dropout_rate)
        elif type==2:
            self.model = self.build_model_without_dropout(input_shape,nb_classes,convfilt, ksize, depth,drop, head_dropout_rate)
        elif type==3:
            self.model = self.build_model_with_L2(input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate)
        elif type==4:
            self.model = self.get_resnet34_se(input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate)
        elif type==5:
            self.model = self.get_resnet34_BNGammaZero(input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate)
        elif type==6:
            self.model = self.get_resnet34_BN2(input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate)

    def build_model(self,input_shape,nb_classes,convfilt, ksize, depth,drop, head_dropout_rate):
        ...
        if head_dropout_rate > 0:
            x_ecg = keras.layers.Dropout(head_dropout_rate)(x_ecg)
    ...
    def build_model_without_dropout(self,input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate):
    ...
    def build_model_with_L2(self,input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate):
    ...
    def get_resnet34_se(self,input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate):
    ...
    def get_resnet34_BNGammaZero(self,input_shape,nb_classes,convfilt, ksize,depth,drop,head_dropout_rate):
    ...
    def get_resnet34_BN2(self,input_shape,nb_classes,convfilt, ksize,depth,drop, head_dropout_rate):
...
if __name__ == '__main__':
    ...
    model = Classifier_RESNET_V2((30000,12), 3, type=1).model
    model.summary()
